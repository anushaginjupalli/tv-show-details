...
// import GenreDetailsComponent from '@/components/GenreDetailsComponent.vue';
// import SearchResultsComponent from '@/components/SearchResultsComponent.vue';
// import SearchComponent from '@/components/SearchComponent.vue';

describe('In home page component', () => {
  let homeWrapper;
  let localVue;
  let mockStore;
  ...
  it('renders the correct markup', () => {
    expect(homeWrapper.html()).toContain('<div class="mrl-15 mb">');
  });

  it('it should have a div element with class="mrl-15 mb"', () => {
    expect(homeWrapper.attributes('class')).toBe('mrl-15 mb');
  });

  // describe('it should load GenreDetails component', () => {
  //   it('it should load the GenreDetailsComponent', () => {
  //     expect(GenreDetailsComponent).toBeTruthy();
  //   });

  //   it('it should load the SearchComponent', () => {
