...
describe('In Genre Details Component', () => {
  let genreDetailsWrapper;
  let localVue;
  beforeEach(() => {
      ...
      genreDetailsWrapper = shallowMount( GenreDetailsComponent, {  
        propsData: { genre, showdetails },
      localVue,     
    });
  });

  it('is a Vue instance', () => {
    expect(genreDetailsWrapper.isVueInstance).toBeTruthy();
  });

  it('renders the correct markup', () => {
    expect(genreDetailsWrapper.html()).toContain('<div class="container">');
  });
